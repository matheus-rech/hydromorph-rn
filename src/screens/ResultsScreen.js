...
export default function ResultsScreen({ navigation, route }) {
  ...
  // Retrieve multi-model results from module store (lazy, only when tab is active)
  ...
  return (
    <View style={styles.screen}>
      ...
      {/* Tab bar — only shown when multi-model results are available */}
      {multiModelResults && (
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        {/* ── Detail Tab (original sections A-F) ───────────────────────── */}
        {activeTab === 'detail' && (
        <>
        {/* ── A: NPH Assessment ───────────────────────────────────────────── */}
